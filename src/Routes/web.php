...
Route::prefix('mobile')->middleware(['web', 'auth', 'device_mobile', 'store'])->group(function () {
    ...
    Route::prefix('transaction')->group(function () {
        ...
        Route::get("cicilan/{id}", [TransactionController::class, 'listCicilan'])->name("m.cicilan");

        Route::prefix('due-detail')->group(function () {
            Route::get("get-cicilan/{id}", [DueController::class, 'getCicilan'])->name("due.cicilan"); 
        });
